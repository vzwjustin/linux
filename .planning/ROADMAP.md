...
- [ ] **Phase 8: VPS Aggregation Endpoint** - Server-side implementation for traffic aggregation
- [ ] **Phase 9: Tooling Integration** - ss, ip, iproute2, and proc/sys interfaces
- [ ] **Phase 10: Quality and Upstream** - checkpatch clean, KUnit tests, documentation
...
Plans:
- [ ] 08-01-PLAN.md - Multi-tenant server PSK authentication and connection acceptance
- [ ] 08-02-PLAN.md - TCP-over-QUIC tunnel termination with zero-copy splice forwarding
- [ ] 08-03-PLAN.md - Userspace tquicd daemon with Prometheus metrics and dashboard
- [ ] 08-04-PLAN.md - Debian package with systemd service and kernel tuning
...
Plans:
- [ ] 09-01: Complete sysctl interface
- [ ] 09-02: ip tquic command implementation
- [ ] 09-03: Netfilter hooks
- [ ] 09-04: Per-netns support
- [ ] 09-05: Routing table integration
...
Plans:
- [ ] 10-01: checkpatch cleanup
- [ ] 10-02: KUnit test suite - protocol core
- [ ] 10-03: KUnit test suite - path manager
- [ ] 10-04: KUnit test suite - scheduler
- [ ] 10-05: Kernel documentation
- [ ] 10-06: Man pages and MAINTAINERS entry
...
| 8. VPS Aggregation Endpoint | 0/4 | Planned | - |
| 9. Tooling Integration | 0/5 | Not started | - |
| 10. Quality and Upstream | 0/6 | Not started | - |
