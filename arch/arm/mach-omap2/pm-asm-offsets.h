...
#define EMIF_PM_RUN_HW_LEVELING 8 /* offsetof(struct ti_emif_pm_functions, run_hw_leveling) */
#define EMIF_PM_ENTER_SR_OFFSET 12 /* offsetof(struct ti_emif_pm_functions, enter_sr) */
#define EMIF_PM_EXIT_SR_OFFSET 16 /* offsetof(struct ti_emif_pm_functions, exit_sr) */
#define EMIF_PM_ABORT_SR_OFFSET 20 /* offsetof(struct ti_emif_pm_functions, abort_sr) */
